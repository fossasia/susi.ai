...
import _TogglePassword from '@material-ui/icons/RemoveRedEye';
...
export const OutlinedInput = styled(_OutlinedInput)`
  ...
  ${(props) =>
    ...
    `}
`;
export const TogglePassword = styled(_TogglePassword)`
  position: absolute;
  transform: translate(120px);
  margin: 0.625rem auto;
  cursor: pointer;
`;
export const PasswordField = styled(_TextField)`
  width: 17rem;
  margin: 0.625rem auto;
`;
